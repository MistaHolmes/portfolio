...
export default function Model(props: ThreeElements['group']) {
  ...
  const { nodes, materials } = useGLTF("/thor_and_the_midgard_serpent-transformed.glb") as unknown as GLTFResult
  return (
...
useGLTF.preload("/thor_and_the_midgard_serpent-transformed.glb")
